...
class SalesModelServiceQuoteSubmitBeforeObserver implements ObserverInterface
{
    ...
    public function execute(EventObserver $observer)
    {
        ...
        {       
            if ($orderItem->getProductType() == 'booking') {

                // if (!isset($orderItem['product_options']['info_buyRequest']['booking-type'])) {

                //     throw new \Magento\Framework\Exception\LocalizedException(__('Can not reorder product.You have to order products manually.'));
                // }
