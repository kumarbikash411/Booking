 ...
 */
class NonWorkingDaysOptions extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\AbstractModifier
{
    /**#@+
     * Group values
     */
   ...
   // const FIELD_START_DATE_NAME = 'start_date';
    ...
    public function modifyMeta(array $meta)
    {
        ...
        if ($attribute_set_name == 'Daily Rent Booking') { 
            $this->createCustomOptionsPanel($attribute_set_name);
        }
     ...
     * @return $this
     */
    protected function createCustomOptionsPanel($attribute_set_name)
    {
            ...
            [
                static::GROUP_NAME => [
                    ...
                    'children' => [
                        ...
                        static::GRID_OPTIONS_NAME => $this->getOptionsGridConfig(320,$attribute_set_name)
                    ]
                ]
            ]
        );
     ...
     * @return array
     */
    protected function getOptionsGridConfig($sortOrder,$attribute_set_name)
    {
        if ($attribute_set_name == 'Daily Rent Booking') {
            return [
                'arguments' => [
                    'data' => [
                        'config' => [
                            'addButtonLabel' => __('Add Non Working Rules'),
                        ...
                        'children' => [
                            static::CONTAINER_OPTION => [
                                ...
                                'children' => [
                                    ...
                                    static::CONTAINER_COMMON_NAME => $this->getCommonContainerConfig(20,$attribute_set_name),
     ...
     * @return array
     */
    protected function getCommonContainerConfig($sortOrder,$attribute_set_name)
    {
        ...
        if ($attribute_set_name == 'Daily Rent Booking') {
            $commonContainer = [
                ...
                'children' => [
                    ...
                    static::FIELD_TYPE_NAME => $this->getDateTypeFieldConfig(30),
                ]
            ];
        } 
     ...
     * @return array
     */
    protected function getDateAndDaysTypeFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'component' => 'Ced_Booking/js/custom-options-type',
     ...
     * @return array
     */
    protected function getDateTypeFieldConfig($sortOrder)
    {
        return [
            'arguments' => [
                'data' => [
                    'config' => [
                        ...
                        'dataType' => Text::NAME,
                        'sortOrder' => $sortOrder,
                        'options' => $this->getDateProductOptionTypes(),
                        'disableLabel' => true,
                        'multiple' => false,
                        'width' => '500px',
                        'selectedPlaceholders' => [
    ...
    protected function getDateProductOptionTypes() 
    {
        $options = [];
        $groupIndex = 0;
