...
//use Ced\Booking\Ui\DataProvider\Product\Form\Modifier\BookingPanel;
...
{
    const DATA_SCOPE = '';
    const DATA_SCOPE_CUSTOMER = 'bookingfacilities';
    const GROUP_CUSTOMERTAB = 'bookingfacilities';
