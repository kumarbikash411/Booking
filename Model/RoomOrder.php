...
class RoomOrder extends \Magento\Framework\Model\AbstractModel 

{
     ...
     * @var string
     */
    protected $_eventPrefix = 'booking_room_order';
...

	{
		...
		$this->_init('Ced\Booking\Model\ResourceModel\RoomOrder');
