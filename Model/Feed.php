...
class Feed extends \Magento\AdminNotification\Model\Feed
{
    ...
    const XML_FEED_URL_PATH     = 'system/cedcommerce/feed_url';
    const XML_FREQUENCY_PATH    = 'system/cedcommerce/frequency';
    const XML_LAST_UPDATE_PATH  = 'system/cedcommerce/last_update';
    ...
    public function checkUpdate()
    {
        ...
        $feedXml = $this->getFeedData($this->_objectManager->get('Ced\Booking\Helper\Feed')->getEnvironmentInformation());
        ...
        if ($feedXml && $feedXml->channel && $feedXml->channel->item) {
            ...
            $installedModules=$this->_objectManager->get('Ced\Booking\Helper\Feed')->getCedCommerceExtensions();
            foreach ($feedXml->channel->item as $item) {
               
                if(!isset($installedModules[(string)$item->module])) {
                    continue;
                }
                if($this->_objectManager->get('Ced\Booking\Helper\Feed')->isAllowedFeedType($item)) {
