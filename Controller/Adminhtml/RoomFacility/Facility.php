...
namespace Ced\Booking\Controller\Adminhtml\RoomFacility;
...
class Facility extends \Magento\Backend\App\Action

{
	...
	public function execute()
	{
			...
			$template = $resultPage->getLayout()->createBlock('Ced\Booking\Block\Adminhtml\Room\Facility')->setTemplate('Ced_Booking::catalog/product/room_facility.phtml')->toHtml();
