...
class CheckRentTypeProductAvailability extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
       ...
       $template = $resultPage->getLayout()->createBlock('Ced\Booking\Block\CheckRentTypeProductAvailability')
                   ->setData(['data'=>$params])
                   ->setTemplate('Ced_Booking::product/view/check_rent_type_product_availability.phtml')
                   ->toHtml();
