...
class SearchRoom extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        $template = $resultPage->getLayout()->createBlock('Ced\Booking\Block\SearchedRoomsListing')
                       ->setData(['paramsdata'=>$params])
                       ->setTemplate('Ced_Booking::product/view/searched_rooms_listing.phtml')
                       ->toHtml();
