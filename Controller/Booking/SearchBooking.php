...
class SearchBooking extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        $template = $resultPage->getLayout()->createBlock('Ced\Booking\Block\BookingFilter')
                         ->setData(['post'=>$post])
                         ->setTemplate('Ced_Booking::filter.phtml')
                         ->toHtml();
