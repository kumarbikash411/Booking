...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function getHeaderText()
    {
    	...
    	if ($this->_coreRegistry->registry('ced_order_data')->getId()) {
            return __("Edit Post '%1'", $this->escapeHtml($this->_coreRegistry->registry('ced_order_data')->getTitle()));
        } else {
            return __('New Order');
        }
    }
    ...
    {
    	return $this->_coreRegistry->registry('ced_order_data');
    }  
