...
namespace Ced\Booking\Block\Adminhtml\EditRoom\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $form->setHtmlIdPrefix('edit_room_page_');
        ...
        if (count($roomtypesModel)!=0) {
         ...
         if ($RoomId != null) {
          ...
          $user->setAfterElementHtml("
            ...
            document.getElementById('room_numbers_block').style.display='block';
              
            window.onload = function() {

              var type = document.getElementsByName('exclude_days').value;
              ...
              if(type == 'text')
                  ...
                  document.getElementById('room_numbers_block').style.display='none';
                    }
            };
