...
class Facilities extends \Magento\Backend\Block\Widget\Container
{
	 ...
	 * @var string
	 */
	protected $_template = 'facilities/view.phtml';
	...
	{	
		$this->setChild(
				'grid',
				$this->getLayout()->createBlock('Ced\Booking\Block\Adminhtml\Facilities\Grid', 'grid.view.grid')
		);
