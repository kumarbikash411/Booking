...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    public function getHeaderText()
    {
    	...
    	if ($this->_coreRegistry->registry('ced_attribute_data')->getId()) {
            return __("Edit Post '%1'", $this->escapeHtml($this->_coreRegistry->registry('ced_attribute_data')->getTitle()));
        } else {
    ...
    {
    	return $this->_coreRegistry->registry('ced_attribute_data');
    }  
