...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset  
{
    ...
    public function __construct(
        ...
        $this->_helper = $this->_objectManager->get('Ced\Booking\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
		...
		$modules =  $this->_objectManager->get('\Ced\Booking\Helper\Feed')->getAllModules();
	...
	protected function _getFieldHtml($fieldset, $moduleName,$currentVersion = '0.0.1',$moduleProductName = '')
    {
    	...
    	$level = \Ced\Booking\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_level';
	 	...
	 	$helper = $this->_objectManager->create('\Ced\Booking\Helper\Data');
		...
		$l = $this->_objectManager->create('\Ced\Booking\Helper\Feed')->getLicenseFromHash($hash,$level);
